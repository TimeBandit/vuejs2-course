    ...
    <form>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          <div class="form-group">
            <label for="sendmail">
              <!-- both checkboxes are bound to the same array with their value attributes -->
              <!-- values of checkboxes are added to the same array -->
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <!-- use an inline style to preserve the line breaks -->
